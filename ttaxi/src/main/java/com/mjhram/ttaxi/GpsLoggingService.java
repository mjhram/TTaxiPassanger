...
import com.mjhram.ttaxi.common.IntentConstants;
...
public class GpsLoggingService extends Service  {
    ...
    private void HandleIntent(Intent intent) {
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                ...
                //availabilityState = bundle.getInt("availabilityState");
    ...
    private void ShowNotification() {
        ...
        annotateIntent.setAction("com.mjhram.ttaxi.NOTIFICATION_BUTTON");
        ...
        //if (nfc == null)
        {
            int idSmall=R.drawable.availablesmall,
                    idLarge=R.drawable.availablelarge;
            switch(Session.availabilityState) {
                case 0:
                    idSmall = R.drawable.availablesmall;
                    idLarge = R.drawable.availablelarge;
                    break;
                case 1:
                    idSmall = R.drawable.busysmall;
                    idLarge = R.drawable.busylarge;
                    break;
                case 2:
                    idSmall = R.drawable.outofservicesmall;
                    idLarge = R.drawable.outofservicelarge;
                    break;
            }
    ...
    void OnLocationChanged(Location loc) {
        ...
        //EventBus.getDefault().post(new ServiceEvents.LocationUpdate(loc));//moved to the begging
     ...
     * @param loc Location object
     */
    private void WriteToFile(MyInfo loc) {
